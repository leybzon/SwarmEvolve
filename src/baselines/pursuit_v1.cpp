...
//
// "Nearest-Enemy Pursuit" baseline (M3). FROZEN COPY.
//
// This file intentionally uses the placeholder namespace
// `TEAM_NS_PLACEHOLDER`. The test harness
// (tests/test_baselines.py::compile_matchup) rewrites the placeholder to
// either `TeamA` or `TeamB` before compiling, so the same source can be
// used on either side.
//
// Do not edit this file for behavior changes — bump the version
// (`pursuit_v2.cpp`) per src/baselines/README.md instead.
//
// Strategy:
